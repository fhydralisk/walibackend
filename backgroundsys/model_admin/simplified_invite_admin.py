...
class InviteInfoAdmin(SimpleHistoryAdmin):
    list_display = ('uid_s', 'dmid_s', 'uid_t', 'dmid_t', 'i_status', 'quantity', 'price', 'operate',)
...
class InviteCancelReasonAdmin(SimpleHistoryAdmin):
    list_display = ('id','reason','in_use')


to_register = [
    (invite.InviteInfo, InviteInfoAdmin),
    (invite.InviteCancelReason, InviteCancelReasonAdmin),
]
